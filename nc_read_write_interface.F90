...
!Any comments please send to huangwenyu@mail.tsinghua.edu.cn                      
    ...
    public nc_read_write_interface_write_scalar
    public nc_read_write_interface_write_dim
    public nc_read_write_interface_write_var_nod
    ...
    interface nc_read_write_interface_write_var_nod
        module procedure write_1dvar_nod_int
    end interface nc_read_write_interface_write_var_nod 
    ...
    interface nc_read_write_interface_write_scalar
        module procedure write_1scal_int 
    end interface nc_read_write_interface_write_scalar
    ...
    subroutine write_1dvar_int (dvar, file_name, dim_name, dvar_name, long_name, units, Fill_Value,  dim_count, n_d)
        ...
        ierr = nf90_def_var (ncid, dvar_name, nf90_int, (/dim_dimid/), dvar_id)
        call handle_err (ierr)
    ...
    !---------------------------------------------------------------------
    !---------------------------------------------------------------------
    !                          Subroutine write_1scal_int 
    !---------------------------------------------------------------------
    subroutine write_1scal_int (dvar,file_name,dvar_name,long_name,units,Fill_Value)
        implicit none
        integer,                intent (in)         :: Fill_Value
        character (len = *),    intent (in)         :: units 
        character (len = *),    intent (in)         :: long_name 
        ...
        ierr = nf90_def_var (ncid, dvar_name, nf90_int,dvar_id)
        call handle_err (ierr)
    ...
    end subroutine write_1scal_int 
    !---------------------------------------------------------------------
    !                    End of Subroutine write_1scal_int 
    !---------------------------------------------------------------------
    !---------------------------------------------------------------------
    !                          Subroutine write_1dvar_nod_int 
    !---------------------------------------------------------------------
    subroutine write_1dvar_nod_int (dvar,dvar_len,file_name,dvar_name,long_name,units,Fill_Value)
        implicit none
        integer,                intent (in)         :: Fill_Value
        character (len = *),    intent (in)         :: units 
        character (len = *),    intent (in)         :: long_name 
        character (len = *),    intent (in)         :: dvar_name 
        character (len = *),    intent (in)         :: file_name 
        integer,                intent (in)         :: dvar_len
        integer,                intent (in)         :: dvar(dvar_len) 
        ...
        ierr = nf90_def_var (ncid, dvar_name, nf90_int, dvar_len, dvar_id)
        call handle_err (ierr)
    ...
    end subroutine write_1dvar_nod_int 
    !---------------------------------------------------------------------
    !                    End of Subroutine write_1dvar_nod_int 
    !---------------------------------------------------------------------
    !---------------------------------------------------------------------
    ...
    subroutine read_5dvar (var, file_name, var_name, start_count, volume_count, dim_count, n_d)
        ...
        real (r8),              intent (out)        :: var &
                                                       (dim_count (1), dim_count (2), dim_count (3), dim_count (4), dim_count (5))
